  ...
  return (
    <div className='flex justify-center items-center min-h-screen bg-pink-100'>
      ...
      <CardHeader>
        ...
        <CardDescription>
          Enter detail to create your account
        </CardDescription>
      ...
      <CardContent>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid gap-2">
              ...
              <Input id="password" name="password" placeholder="Create Password" type={showpassword ? 'text':'password'} required 
      ...
      <CardFooter className="flex-col gap-2">
       ...
       <p className='text-gray-700 text-sm'>Alredy have an account ? <Link to={"/login"} className="hover:underline cursor-pointer text-pink-pointer">login</Link></p>
      </CardFooter>
    </Card>
