...
const FilterSidebar = ({search, setSearch ,category, setCategory,brand,setBrand,setPriceRange,allProducts,priceRange}) => {
  ...
  return (
    <div className='bg-gray-100 mt-10 p-4 rounded-md h-max hidden md:block w-64'>
      ...
      {/* category */}
  <h1 className='mt- font-semibold text-xl'>Category</h1>
  <div className='flex flex-col gap-2 mt-3'>
    {
      ...
      {/* Brand */}
  <h1 className='mt- font-semibold text-xl'>Brand</h1>
  <select className="bg-white w-full p-2 border-gray-200 border-2 rounded-md " id="" value={brand} onChange={handleBrandChange} >
    {
    ...
    {/* Reset button */}
       ...
       <Button onClick={resetFilters} className='bg-pink-600 text-white mt-5 cursor-pointer'>Reset Filters</Button>
    </div>
  )
}
