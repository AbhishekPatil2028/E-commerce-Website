        ...
        <footer className='bg-gray-900 text-gray-200 py-10'>
            <div className='max-w-7xl mx-auto px-4 md:flex md:justify-between'>
                ...
                <div className='mb-6 md:mb-0'>
                    <Link to='/'>
                    <img src="E-cart-logo.png" alt=''className='w-32'/>
                    </Link>
                    <p className='mt-2 text-sm'>Powering Your world with the Best in Electronics.</p>
                    <p className='mt-2 text-sm'>123 Electronics St, Style city, Pune 10001 </p>
                    <p className='text-sm'>Email:support@abhis.com</p>
            ...
            <ul className='mt-2 text-sm space-y-2'>
             ...
             <div className='mb- md:mb-0'>
                ...
                <div className='flex space-x-4 nt-2'>
                    <FaFacebook/>
                    <FaInstagram/>
                    <FaTwitterSquare/> 
                    <FaPinterest/> 
